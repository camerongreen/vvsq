...
<div id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> clearfix"<?php print $attributes; ?>>
  ...
  <div class="entry_date">
    <div class="day"><?php print format_date(strtotime($node->field_start[$node->language][0]['value']), 'custom', 'd'); ?></div>
    <div class="month"><?php print format_date(strtotime($node->field_start[$node->language][0]['value']), 'custom', 'M'); ?></div>

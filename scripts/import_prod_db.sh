...
DEFAULT_DB_FILE=${SITE_BASE_URL}/sql/vvsq_drupal.sql.gz
...
read -p "Database gzipped sql file [${DEFAULT_DB_FILE}]:" DB_FILE
if [ -z $DB_FILE ]
  then
...
drush -y pm-enable context_ui devel rules_admin views_ui stage_file_proxy
